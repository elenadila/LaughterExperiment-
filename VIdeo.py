...
if __name__ == '__main__':
    ...
    #We then instantiate the Frame object which will create the whole GUI
    #app.MainLoop() enters the mainloop. The mainloop is an endless cycle.
    # It catches and dispatches all events that exist during the life of our application
                app = wx.App(redirect=False)
                frame = Frame(None, -1, 'Laughter Experiment', 'C:\Users\user\switchdrive\LaughterExperiment-\MPlayer\mplayer.exe')
                app.MainLoop()